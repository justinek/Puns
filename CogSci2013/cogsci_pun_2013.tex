...
Our model is motivated by the important role that semantic priming plays in lexical disambiguation during sentence processing \cite{seidenberg1982automatic, burke1984semantic}; while ignoring the other non-semantic factors of interpretation (which may also be important).
...
We thank Stu Melton and Mia Polansky for helping create part of the materials used in this paper.  This work was supported in part by a John S. McDonnell Foundation Scholar Award to NDG.
...
\section{Acknowledgments}
We thank Stu Melton and Mia Polansky for helping create part of the materials used in this paper.
