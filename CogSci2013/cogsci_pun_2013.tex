...
\begin{tabular}{ m{6cm}  m{0.7cm}  m{0.7cm} }
\textbf{Semantic focus sets} & \textbf{D} & \textbf{Funniness}\\\hline
The $magician$ was so mad he $\underline{\text{pulled}}$ his $hare$ out. & $2.3$ & $1.7$ \\[2ex]\hline
It was an $\underline{\text{emotional}}$ $\underline{wedding}$. Even the $cake$ was in $tiers$ & $2.3$ & $1.5$\\[2ex]\hlineThe professor got so mad he $\underline{\text{pulled}}$ his $hare$ out & $1.6$ & $0.3$ \\[2ex]\hlineIt was an $\underline{\text{emotional}}$ $\underline{wedding}$. Even the $\underline{\text{mother-in-law}}$ was in $tiers$. & $1.8$ & $0.05$ \\[2ex]\hlineThe $hare$ $ran$ $rapidly$ through the $fields$. & $1.67$ & $-0.4$\\[2ex]\hline$Boxes$ are $stacked$ in $tiers$ in the warehouse. & $2.1$ & $-0.5$\\[2ex]\hline
\end{tabular}
