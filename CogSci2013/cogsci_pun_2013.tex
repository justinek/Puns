...
(Decide which graphical model to use based on role of $h$.)
\begin{center}
\begin{tikzpicture}
...
$$
P(m | \vec w) = \sum_f P(m, f | \vec w) \propto P(\vec w | m, \vec f) P(m) P(\vec f)
$$
$$
=P(m)P(\vec f)\prod_i P(w_i | m, f_i)
$$
...
\begin{figure}[h]
\scalebox{0.44}{\includegraphics{Plots/ambiguity_sentenceType.png}}
\caption{Ambiguity across sentence types}
\end{figure}
\begin{figure}[h]
\scalebox{0.5}{\includegraphics{Plots/ambiguity_funniness.png}}
\caption{Ambiguity correlated with funniness}
\end{figure}

\begin{figure}[h]
\scalebox{0.44}{\includegraphics{Plots/disjointedness_sentenceType.png}}
\caption{Disjointedness across sentence types}
\end{figure}
\begin{figure}[h]
\scalebox{0.5}{\includegraphics{Plots/disjointedness_funniness.png}}
\caption{Disjointedness correlated with funniness}
\end{figure}
...
\begin{figure}[h]
\scalebox{0.5}{\includegraphics{Plots/ambiguity_disjointedness.png}}
