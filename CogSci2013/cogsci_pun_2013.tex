...
\subcaption{Relatedness of each word with two candidate meanings of $h$ for a pun and non-pun}
\end{subfigure}
\begin{subfigure}{0.29\textwidth}
\scalebox{0.4}{\includegraphics{Plots/ave_relatedness.png}}
\subcaption{Average relatedness of content words with two candidate meanings of $h$}
\end{subfigure}
\begin{subfigure}{0.31\textwidth}
\scalebox{0.4}{\includegraphics{Plots/ave_funniness.png}}
\subcaption{Average funniness ratings for different sentence types}
\end{subfigure}
}
...
\end{tabular}
\caption{Regression coefficients using ambiguity and distinctiveness measures to predict funniness ratings}
\label{coefficients}
\end{table}
